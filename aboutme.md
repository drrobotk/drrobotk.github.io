...
In October 2024, I was promoted to Senior Data Engineer within Quantexa’s Research and Development division. This role enables me to lead complex data engineering projects and drive innovation within the company’s technology stack. My responsibilities now include architecting, developing, and optimizing scalable data pipelines that support large-scale data integration, advanced analytics, and entity resolution. I work across both cloud and on-premise infrastructures, leveraging tools like Airflow, Spark, and Google Cloud, with a strong focus on infrastructure optimization, automation, and performance.

A recent highlight was spearheading the implementation of dynamic Directed Acyclic Graphs (DAGs) and autoscaling in Airflow, which has optimized resource usage and boosted scalability. This project reflects my ongoing focus on big data and cloud solutions, and it has also allowed me to refine infrastructure management practices for improved accessibility and best practices across teams.

<p align="center"><img src="/assets/img/airflow.gif" alt="isolated" width="700"/></p>  

Mentorship has become a rewarding part of my role. I work closely with junior engineers, guiding them through coding challenges, conducting code reviews, and creating a collaborative learning environment. My expertise in Scala and Python has been instrumental in tackling complex data engineering problems and supporting the professional growth of emerging engineers, especially as we manage large-scale data and distributed systems.

Innovation is central to my work, and I’ve recently developed a dynamic DAG generator that allows ETL pipelines to be created directly from configuration files. This has streamlined the workflow and enabled rapid deployment of custom data pipelines. My vision is to expand this into a web-based application with a drag-and-drop interface, empowering data engineering teams to design, configure, and deploy pipelines more efficiently. This project reflects my commitment to building accessible tools that democratize data engineering and enhance productivity.

Beyond technical projects, I’m responsible for setting and implementing best practices in ETL pipelines, big data processing, and data standardization. These initiatives ensure that large-scale datasets are delivered with high quality, consistency, and reliability, enabling more accurate analytics and better decision-making. My experience with Spark, Hadoop, and Elasticsearch supports strategic efforts like data classification and entity extraction, both of which are integral to building contextualized insights.

More recently, I have taken on a DataOps function, a role that stretches beyond building pipelines to ensuring that the entire data lifecycle is reliable, observable, and automated. This means running daily operations — from scheduled ETLs and entity resolution runs to post-processing and reporting — while also designing processes that scale and can be made self-service for others. It is a balance between immediate operational reliability and long-term improvements, and it has given me a broader perspective on how engineering practices translate directly into business outcomes.

Much of this work involves making complex infrastructure more resilient. I have dealt with challenges such as jobs being terminated unexpectedly, transient failures in distributed environments, and instability in supporting systems. Where deep infrastructure changes are required, I collaborate with platform teams, but where possible I also add resilience layers myself — retries, safety nets, and better logging — so that pipelines can withstand faults without constant intervention. This ensures that critical data processing remains dependable, even under less-than-ideal conditions.

Another important part of DataOps is bridging across stakeholders. Different groups depend on reliable data workflows, and part of my responsibility is to ensure their needs are met consistently despite the complexity of the systems involved. This has meant formalising “contracts” around data refreshes, reporting, and integration points, and finding ways to reduce friction when requests come in. By automating repeatable tasks and building clearer interfaces, I have helped make DataOps more predictable, transparent, and scalable.

Taking on DataOps has also meant looking ahead to how the function can mature. My focus has been on creating workflows that are not only resilient but also productised — packaging Airflow modules, streamlining configuration, and setting the stage for pipelines that are both observable and self-healing. My vision is for DataOps to become an enabler rather than a bottleneck: something that empowers engineers to trigger, monitor, and debug pipelines without manual intervention, while giving stakeholders confidence that data will always be where it needs to be, when it needs to be there.

I am also a strong advocate for neurodiversity and inclusivity, particularly for ADHD and dyslexic perspectives. I bring this advocacy to my work by emphasising clear documentation, accessible resources, and continuous learning opportunities, ensuring that all team members can contribute effectively.

As I continue my journey, I look forward to the new challenges, learning opportunities, and contributions to data engineering. I remain dedicated to building systems that are robust, accessible, and impactful, and to aligning my work with the broader mission of delivering actionable insights through contextualised data.